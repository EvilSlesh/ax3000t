...
- Manual Upgrade Required: Sing-box must be manually upgraded via the Passwall2 App Update page due to router storage limits; all other packages install automatically at their latest versions. (Currenty we are working to make this automated!)
